...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $opponent->stakeholder_id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $opponent->stakeholder_id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column column-80">
        <div class="opponents form content">
            ...
            <fieldset>
                <legend><?= __('Edit Opponent') ?></legend>
                <?php
